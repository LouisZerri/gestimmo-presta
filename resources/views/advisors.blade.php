...
<div class="bg-white shadow-sm border-b border-gray-200 sticky top-20 z-30">
    <div class="max-w-7xl mx-auto px-4 py-6">
        <div class="relative max-w-3xl mx-auto">
            ...
            <button class="absolute right-2 top-2 bottom-2 bg-brand-blue text-white px-6 rounded-full font-bold hover:bg-blue-800 transition">
                Chercher
            </button>
        </div>
    </div>
    ...
    <div id="advisors-grid" class="w-full">
        <div class="w-full py-12 flex flex-col items-center justify-center text-center px-4">
            <div class="bg-blue-50 border border-blue-100 rounded-3xl p-8 max-w-2xl shadow-sm">
                <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm text-brand-blue text-3xl">
                ...
                <p class="text-gray-600 mb-8 text-lg leading-relaxed">
                    L'affichage de la carte est momentanément indisponible le temps de l'actualisation de nos données.<br>
                ...
                <button onclick="openContactModal()" class="bg-brand-blue text-white font-bold py-4 px-10 rounded-full hover:bg-blue-800 transition shadow-lg transform hover:-translate-y-1 flex items-center justify-center mx-auto gap-3">
...
{{-- MODALE CONTACT --}}
<div id="contact-modal" class="fixed inset-0 z-[70] hidden bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg relative overflow-hidden">
        <button onclick="closeContactModal()" class="absolute top-4 right-4 bg-gray-100 hover:bg-gray-200 text-gray-600 w-8 h-8 rounded-full flex items-center justify-center z-50 transition">
        ...
        <div class="p-8">
            <form class="space-y-4" method="POST" action="#">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <input type="text" name="nom" placeholder="Nom" class="w-full p-3 bg-gray-50 rounded-lg border focus:border-brand-blue outline-none">
                    <input type="text" name="prenom" placeholder="Prénom" class="w-full p-3 bg-gray-50 rounded-lg border focus:border-brand-blue outline-none">
                </div>
                ...
                <input type="text" name="localisation" placeholder="Code postal / Ville du bien" class="w-full p-3 bg-gray-50 rounded-lg border focus:border-brand-blue outline-none">
                <textarea name="message" rows="3" placeholder="Précisez votre demande..." class="w-full p-3 bg-gray-50 rounded-lg border focus:border-brand-blue outline-none"></textarea>
                <button type="submit" class="w-full bg-brand-blue text-white font-bold py-3 rounded-lg hover:bg-blue-800 transition shadow-md">
                    Envoyer ma demande
                </button>
            </form>
        </div>
