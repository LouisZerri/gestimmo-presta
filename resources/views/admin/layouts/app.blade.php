        ...
        <aside class="w-64 bg-brand-blue text-white flex-shrink-0 fixed inset-y-0 left-0 overflow-y-auto">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('admin.testimonials.index') }}"
                   class="flex items-center px-6 py-3 hover:bg-white/10 transition-colors {{ request()->routeIs('admin.testimonials.*') ? 'bg-white/10 border-r-4 border-brand-accent' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.edlya.index') }}"
                   class="flex items-center px-6 py-3 hover:bg-white/10 transition-colors {{ request()->routeIs('admin.edlya.*') ? 'bg-white/10 border-r-4 border-brand-accent' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
