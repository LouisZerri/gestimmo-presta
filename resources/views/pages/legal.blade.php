...
<div class="bg-brand-light py-16">
    <div class="max-w-4xl mx-auto px-4">
        <h1 class="font-heading font-bold text-4xl text-gray-900 mb-8">Mentions Légales</h1>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-8 md:p-12">
            <div class="prose prose-lg max-w-none">
                ...
                <div class="bg-gray-50 rounded-xl p-6 my-6 not-prose">
                    ...
                    <ul class="space-y-2 text-gray-600">
                        <li class="flex items-start gap-2">
                            <i class="fas fa-building text-gray-400 mt-1 w-5"></i>
                            <span><strong>Forme juridique :</strong> SARL</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class="fas fa-euro-sign text-gray-400 mt-1 w-5"></i>
                            <span><strong>Capital social :</strong> 1 000 €</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class="fas fa-map-marker-alt text-gray-400 mt-1 w-5"></i>
                            <span><strong>Siège social :</strong> 35 rue Aliénor d'Aquitaine, 19360 Malemort, France</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class="fas fa-id-card text-gray-400 mt-1 w-5"></i>
                            <span><strong>Numéro SIRET :</strong> 990 877 417 00016</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class="fas fa-file-alt text-gray-400 mt-1 w-5"></i>
                            <span><strong>RCS :</strong> Brive B 990 877 417</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class="fas fa-globe-europe text-gray-400 mt-1 w-5"></i>
                            <span><strong>Numéro de TVA intracommunautaire :</strong> FR42 990 877 417</span>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="space-y-3 text-gray-700">
                        <li class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="font-medium">35 Rue Aliénor d'Aquitaine, 19360 Malemort</div>
                            </div>
                        </li>
                        <li class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-brand-blue/10 rounded-full flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <a href="tel:0613250596" class="font-medium text-brand-blue hover:underline">06 13 25 05 96</a>
                            </div>
                        </li>
                        <li class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-brand-blue/10 rounded-full flex items-center justify-center">
                                <i class="fas fa-at text-brand-blue"></i>
                            </div>
                            <div>
                ...
                <div class="bg-blue-50 border border-blue-100 rounded-xl p-6 my-6 not-prose">
                    <div class="flex items-start gap-3">
                        <div class="w-10 h-10 bg-brand-blue rounded-full flex items-center justify-center flex-shrink-0">
                            <i class="fas fa-shield-alt text-white"></i>
                        </div>
                        <div>
                            <div class="font-bold text-gray-800 mb-2">Vos droits RGPD</div>
                            <p class="text-sm text-gray-600 mb-3">
                                Conformément au Règlement Général sur la Protection des Données (RGPD) et à la loi Informatique et Libertés, 
                                vous disposez des droits suivants sur vos données :
                            </p>
                            <div class="flex flex-wrap gap-2">
                                <span class="bg-white px-3 py-1 rounded-full text-xs font-bold text-brand-blue border border-brand-blue/20">Accès</span>
                                <span class="bg-white px-3 py-1 rounded-full text-xs font-bold text-brand-blue border border-brand-blue/20">Rectification</span>
                                <span class="bg-white px-3 py-1 rounded-full text-xs font-bold text-brand-blue border border-brand-blue/20">Suppression</span>
                                <span class="bg-white px-3 py-1 rounded-full text-xs font-bold text-brand-blue border border-brand-blue/20">Limitation</span>
                                <span class="bg-white px-3 py-1 rounded-full text-xs font-bold text-brand-blue border border-brand-blue/20">Opposition</span>
                                <span class="bg-white px-3 py-1 rounded-full text-xs font-bold text-brand-blue border border-brand-blue/20">Portabilité</span>
                            </div>
                        </div>
                    </div>
                </div>
