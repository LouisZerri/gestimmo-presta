...
@section('content')
    ...
    {{-- HERO --}}
    <div class="bg-gradient-to-br from-brand-blue to-blue-900 py-20">
        <div class="max-w-7xl mx-auto px-4">
            <div class="max-w-3xl">
                ...
                <h1 class="font-heading font-extrabold text-4xl md:text-5xl text-white mb-4">
                    Barème d'honoraires
                </h1>
        ...
        <div class="max-w-5xl mx-auto px-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h2 class="font-heading font-bold text-xl text-gray-900 mb-2">Honoraires de transaction immobilière</h2>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
                <div class="bg-brand-blue px-8 py-4">
                    <h3 class="font-heading font-bold text-white text-lg">Barème des honoraires de vente</h3>
                </div>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-200">
                                <th class="px-6 py-4 text-left text-sm font-bold text-gray-700">Prix de vente net vendeur</th>
                                <th class="px-6 py-4 text-left text-sm font-bold text-brand-blue">Honoraires maximum</th>
                                <th class="px-6 py-4 text-left text-sm font-bold text-gray-700">Prix de vente net vendeur</th>
                                <th class="px-6 py-4 text-left text-sm font-bold text-brand-blue">Honoraires maximum</th>
                            </tr>
                        </thead>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-brand-blue mt-1 flex-shrink-0"></i>
                        <span class="text-gray-600">Honoraires exprimés TTC, TVA incluse au taux légal en vigueur.</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-brand-blue mt-1 flex-shrink-0"></i>
                        <span class="text-gray-600">Honoraires à la charge du vendeur, sauf stipulation contraire.</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-brand-blue mt-1 flex-shrink-0"></i>
                        <span class="text-gray-600">Le présent barème s'applique au prix net vendeur indiqué au mandat.</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-brand-blue mt-1 flex-shrink-0"></i>
                        <span class="text-gray-600">Les montants indiqués constituent des plafonds.</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fas fa-check-circle text-brand-blue mt-1 flex-shrink-0"></i>
                        <span class="text-gray-600">Le barème complet est consultable sur simple demande ou sur le site internet du réseau.</span>
                    </li>
                </ul>
            ...
            <div class="mt-12 text-center">
                <p class="text-gray-600 mb-6">Une question sur nos honoraires ? Contactez-nous pour plus d'informations.</p>
