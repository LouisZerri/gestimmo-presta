    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-10 sm:mb-12">
            ...
            <div class="col-span-2 sm:col-span-2 md:col-span-1">
                ...
                <p class="text-gray-500 text-xs sm:text-sm leading-relaxed mb-4">Le premier réseau immobilier hybride qui réunit transaction, investissement et gestion.</p>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('faq') }}" class="text-gray-500 hover:text-brand-blue transition text-sm font-medium">
                            Centre d'aide (FAQ)
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('contact') }}" class="text-gray-500 hover:text-brand-blue transition text-sm font-medium">
                            Contact
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('advisors') }}" class="text-gray-500 hover:text-brand-blue transition text-sm font-medium">
                            Nos conseillers
                        </a>
                    </li>
                </ul>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('invest') }}" class="text-gray-500 hover:text-brand-blue transition text-sm font-medium">
                            Investissement Locatif
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('sell') }}" class="text-gray-500 hover:text-brand-blue transition text-sm font-medium">
                            Vendre un bien
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('rental') }}" class="text-gray-500 hover:text-brand-blue transition text-sm font-medium">
                            Gestion Locative
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('manage') }}" class="text-gray-500 hover:text-brand-blue transition text-sm font-medium">
                            Syndic
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('insurance') }}" class="text-gray-500 hover:text-brand-blue transition text-sm font-medium">
                            Assurances
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('edl') }}" class="text-gray-500 hover:text-brand-blue transition text-sm font-medium">
                            État des Lieux
                        </a>
                    </li>
                </ul>
